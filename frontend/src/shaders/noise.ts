/**
 * Re-usable GLSL noise snippets. Inlined into vertex/fragment shaders via
 * tagged-template concat at module-graph build time (zero runtime cost).
 *
 * `snoise3` is Ashima Arts' Simplex 3D noise, public-domain.
 */
